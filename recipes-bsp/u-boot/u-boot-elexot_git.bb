DESCRIPTION = "U-Boot for Elexontech NXP boards"
...
SRC_URI = "git://github.com/simong01/u-boot.git;branch=${SRCBRANCH};protocol=https"
...
LIC_FILES_CHKSUM:elexotn91 = "${LIC_FILES_CHKSUM_2024}"
...
PV:elexotn91 = "${PV_2024}"

SRCBRANCH = "boundary-v2022.04"
SRCBRANCH_2024 = "elexot-lf_v2024.04"
